  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold font-quicksand text-main-color">
          Property Listings
        </h1>
      ...
      {properties.length === 0 ? (
        <div className="text-center py-16">
          <h2 className="font-quicksand font-medium text-xl text-main-color">
            No properties listed yet
          </h2>
          <p className="font-quicksand mt-2 text-gray-500">
            Click the "Add New Property" button to create your first property
            listing
          </p>
        </div>
      ) : (
