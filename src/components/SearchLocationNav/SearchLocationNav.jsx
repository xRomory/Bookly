    ...
    <>
      <div className="search-container fixed flex m-8">
        <label>
          ...
          <div onClick={showSideBar} className="toggle-menu-side absolute top-2 left-12">
      ...
      <div className={`side-panel-menu-container absolute w-[450px] h-full ${active ? 'active-menu' : ''}`}>
        <div className="menu-side h-full w-[450px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] flex flex-col items-center">
          ...
          <div onClick={removeSideBar} className="close-navbar absolute top-4 right-4 text-2xl text-blue-900 hover:text-orange-400">
...
export default SearchLocationNav;
